...
function GLUE = RunGLUE(Im1,Im2, params)
    ...
    IRF2 = 0;
    IA1 = -4;
    IA2 = 4; %Maximum allowed disparity in lateral D
    ...
    IRF1 = 0;  %1  DON't CHANGE % Maximum allowed disparity in axial D
    IRF2 = 40;    %2  DON't CHANGE
    ...
    midA = round(size(Im1,2)/2);  %5  MAY CHANGE
     alfa = 5;    %6  DON't CHANGE % Axial regularization
     beta = 10;   %7  DON't CHANGE % Lateral regularization
     ...
     smth = 1;    %13 DON't CHANGE % Degree of smoothness
